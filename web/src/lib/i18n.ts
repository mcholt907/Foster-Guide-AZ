...
export const UI_STRINGS = {
  ...
  onboarding_welcome_subtitle:  { en: "This place is for you. Foster care can be confusing and overwhelming. This is a calm, safe space to find real answers, learn your rights, and figure out your next steps — no sign-up, none of your info is saved.", es: "Este lugar es para ti. El cuidado adoptivo puede ser confuso y abrumador. Este es un espacio tranquilo y seguro para encontrar respuestas reales, conocer tus derechos y descubrir tus próximos pasos — sin registro, ninguno de tu información se guarda." },
