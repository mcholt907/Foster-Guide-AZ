...
export const TEEN_STRINGS = {
  ...
  "shell.command_center":    { en: "Your Hub",               es: "Tu Espacio" },
  ...
  "dashboard.kicker":              { en: "Your Tools",                 es: "Tus Herramientas" },
  ...
  "team.label.insight":  { en: "Strategic Insight",            es: "Consejo Estratégico" },
  "team.faqs.heading":   { en: "Questions on your advocacy?",  es: "¿Preguntas sobre tu defensa?" },
  "team.faqs.subheading":{ en: "Understanding the complexities of the courtroom is a fundamental right.",
                           es: "Entender las complejidades del tribunal es un derecho fundamental." },
  ...
  "wellness.grounding.tag":      { en: "Instant Relief",                   es: "Alivio Inmediato" },
  "wellness.grounding.title":    { en: "The 5-4-3-2-1 Reset",              es: "El Reinicio 5-4-3-2-1" },
  "wellness.grounding.body":     { en: "This exercise pulls your brain out of overdrive by grounding you in your actual environment through your five senses.",
                                   es: "Este ejercicio saca a tu cerebro del sobreesfuerzo al anclarte en tu entorno real a través de tus cinco sentidos." },
  "wellness.grounding.cta":      { en: "Start Immersive Exercise",         es: "Empezar Ejercicio Inmersivo" },
  "wellness.grounding.prompt":   { en: "Name {n} {noun}",                  es: "Nombra {n} {noun}" },
  "wellness.grounding.next":     { en: "Next Sense",                       es: "Siguiente Sentido" },
  "wellness.grounding.finish":   { en: "Finish & Reset",                   es: "Terminar y Reiniciar" },
  "wellness.grounding.close":    { en: "Close exercise",                   es: "Cerrar ejercicio" },
  "wellness.support.kicker":     { en: "Direct Access",                    es: "Acceso Directo" },
  "wellness.support.body":       { en: "Real people who care, available 24/7. Reaching out isn't weakness — it's the highest form of taking care of yourself.",
                                   es: "Personas reales que se preocupan, disponibles 24/7. Pedir ayuda no es debilidad — es la forma más alta de cuidarte." },
  "wellness.support.note":       { en: "All calls and texts are private. These teams are trained specifically to help youth in foster care.",
                                   es: "Todas las llamadas y mensajes son privados. Estos equipos están entrenados específicamente para ayudar a jóvenes en cuidado adoptivo." },
  "wellness.quote":              { en: "What you feel makes sense given what you've been through. You are building resilience every single day.",
                                   es: "Lo que sientes tiene sentido dado lo que has pasado. Estás construyendo resiliencia todos los días." },
  ...
  "ask.topics.kicker":     { en: "Quick Topics",                   es: "Temas Rápidos" },
  "ask.topics.clear":      { en: "Clear Filters",                  es: "Borrar Filtros" },
  "ask.advisor.heading":   { en: "Strategic Advisor",              es: "Asesor Estratégico" },
  "ask.advisor.quote":     { en: "Knowledge is your strongest currency. When you understand the law, adults have to listen. Focus on your rights first.",
                             es: "El conocimiento es tu moneda más fuerte. Cuando entiendes la ley, los adultos tienen que escucharte. Enfócate en tus derechos primero." },
  "ask.advisor.tip1.label":{ en: "Pro Tip No.1",                   es: "Consejo N.º 1" },
  "ask.advisor.tip1.body": { en: "Always ask your lawyer for a copy of the actual statute discussed in court.",
                             es: "Siempre pide a tu abogado/a una copia del estatuto discutido en la corte." },
  "ask.advisor.tip2.label":{ en: "Pro Tip No.2",                   es: "Consejo N.º 2" },
  "ask.advisor.tip2.body": { en: "If a decision affects your rights, it must be documented in writing.",
                             es: "Si una decisión afecta tus derechos, debe estar documentada por escrito." },
  "ask.callout.heading":   { en: "Need specific advice?",          es: "¿Necesitas consejo específico?" },
  "ask.callout.body":      { en: "These answers are general guidance. Your lawyer is the only one who can give you legal advice about your specific case.",
                             es: "Estas respuestas son orientación general. Tu abogado/a es la única persona que puede darte consejo legal sobre tu caso específico." },
  "ask.callout.cta":       { en: "Meet Your Team",                 es: "Conoce a tu Equipo" },
  "ask.footer.quote":      { en: "You have the right to a clear future. The more you know, the stronger that future becomes.",
                             es: "Tienes derecho a un futuro claro. Cuanto más sabes, más fuerte se vuelve ese futuro." },
  "ask.footer.tag":        { en: "FosterHub • Arizona",            es: "FosterHub • Arizona" },
